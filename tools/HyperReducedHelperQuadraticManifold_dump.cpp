/******************************************************************************
*  HyperReducedHelperQuadraticManifold_dump — parity-test helper.
******************************************************************************/
...
using modelorderreduction::HyperReducedHelperQuadraticManifold;
...
int main(int argc, char** argv)
{
    ...
    HyperReducedHelperQuadraticManifold helper;
    helper.d_prepareECSW.setValue(true);
    helper.d_quadraticManifoldBundle.setValue(argv[1]);
    ...
    std::cout << "dumped quadratic-manifold GieUnit (m=" << GieUnit.size()
              << ") for bundle=" << argv[1] << "\n";
    return 0;
}
