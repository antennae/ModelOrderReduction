...
*   Explicit residual-kernel decoder mapping.                                 *
******************************************************************************/
#pragma once
...
class ResidualKernelMapping : public ModelOrderReductionMapping<TIn, TOut>
{
public:
    SOFA_CLASS(SOFA_TEMPLATE2(ResidualKernelMapping, TIn, TOut),
    ...
    sofa::core::objectmodel::DataFileName d_residualKernelBundle;

protected:
    ResidualKernelMapping();
    ~ResidualKernelMapping() override = default;

    std::unique_ptr<sofa::component::kernel::ResidualKernelProjector> m_projector;
...
extern template class SOFA_MODELORDERREDUCTION_API
    ResidualKernelMapping<sofa::defaulttype::Vec1Types, sofa::defaulttype::Vec3Types>;
#endif
