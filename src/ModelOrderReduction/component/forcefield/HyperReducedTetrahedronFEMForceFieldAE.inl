...
*   AE counterpart of HyperReducedTetrahedronFEMForceFieldKPCA.inl
******************************************************************************/
#pragma once

#include "sofa/core/behavior/BaseLocalForceFieldMatrix.h"
#include <ModelOrderReduction/component/forcefield/HyperReducedTetrahedronFEMForceFieldAE.h>
...
HyperReducedTetrahedronFEMForceFieldAE<DataTypes>::HyperReducedTetrahedronFEMForceFieldAE()
{
}


template<class DataTypes>
inline void HyperReducedTetrahedronFEMForceFieldAE<DataTypes>::accumulateForceSmall( Vector& f, const Vector & p, VecElement::const_iterator elementIt, Index elementIndex )
{
...
template<class DataTypes>
inline void HyperReducedTetrahedronFEMForceFieldAE<DataTypes>::applyStiffnessSmall( Vector& f, const Vector& x, int i, Index a, Index b, Index c, Index d, SReal fact )
{
...
template<class DataTypes>
inline void HyperReducedTetrahedronFEMForceFieldAE<DataTypes>::accumulateForceLarge( Vector& f, const Vector & p, VecElement::const_iterator elementIt, Index elementIndex )
{
    ...
    {
        msg_warning(this) << "TODO(HyperReducedTetrahedronFEMForceFieldAE): support for assembling system matrix when using plasticity.";
    }
}


template<class DataTypes>
inline void HyperReducedTetrahedronFEMForceFieldAE<DataTypes>::accumulateForcePolar( Vector& f, const Vector & p, VecElement::const_iterator elementIt, Index elementIndex )
{
...
template<class DataTypes>
inline void HyperReducedTetrahedronFEMForceFieldAE<DataTypes>::accumulateForceSVD( Vector& f, const Vector & p, VecElement::const_iterator elementIt, Index elementIndex )
{
...
template<class DataTypes>
inline void HyperReducedTetrahedronFEMForceFieldAE<DataTypes>::applyStiffnessCorotational( Vector& f, const Vector& x, int i, Index a, Index b, Index c, Index d, SReal fact )
{
    Displacement X;
...
template <class DataTypes>
void HyperReducedTetrahedronFEMForceFieldAE<DataTypes>::init()
{
...
template<class DataTypes>
inline void HyperReducedTetrahedronFEMForceFieldAE<DataTypes>::addForce(const core::MechanicalParams* /*mparams*/, DataVecDeriv& d_f, const DataVecCoord& d_x, const DataVecDeriv& /* d_v */)
{
    VecDeriv& f = *d_f.beginEdit();
    const VecCoord& p = d_x.getValue();

    SCOPED_TIMER("MORTetraAE::addForce");
    f.resize(p.size());
...
template<class DataTypes>
inline void HyperReducedTetrahedronFEMForceFieldAE<DataTypes>::addDForce(const core::MechanicalParams* mparams, DataVecDeriv& d_df, const DataVecDeriv& d_dx)
{
...
template<class DataTypes>
void HyperReducedTetrahedronFEMForceFieldAE<DataTypes>::draw(const core::visual::VisualParams* vparams)
{
...
template <class DataTypes>
void HyperReducedTetrahedronFEMForceFieldAE<DataTypes>::buildStiffnessMatrix(core::behavior::StiffnessMatrix* matrix)
{
