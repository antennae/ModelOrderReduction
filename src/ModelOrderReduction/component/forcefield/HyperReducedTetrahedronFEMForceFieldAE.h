...
*   AE counterpart of HyperReducedTetrahedronFEMForceFieldKPCA.
*   Same physics + ECSW handling; the only behavioral differences are
*   (a) inheritance from HyperReducedHelperAE, and (b) addForce calls
...
*   the AE helper's updateGie.
*
*   Runtime: option B (mapping-projects). The element loop writes
*   ξ_e · f_e to the Vec3d output and AEMapping::applyJT contracts to q
...
#define SOFAHYPERREDUCEDTETRAHEDRONFEMFORCEFIELDAE_COLORMAP
...
class HyperReducedTetrahedronFEMForceFieldAE
    : public virtual TetrahedronFEMForceField<DataTypes>
    , public modelorderreduction::HyperReducedHelperAE
{
public:
    SOFA_CLASS2(SOFA_TEMPLATE(HyperReducedTetrahedronFEMForceFieldAE, DataTypes),
...
public:
    ...
    HyperReducedTetrahedronFEMForceFieldAE();
...
#if !defined(SOFA_COMPONENT_FORCEFIELD_HYPERREDUCEDTETRAHEDRONFEMFORCEFIELDAE_CPP)
extern template class SOFA_MODELORDERREDUCTION_API HyperReducedTetrahedronFEMForceFieldAE<defaulttype::Vec3Types>;
#endif
} // namespace sofa::component::forcefield
