...
*   kPCA counterpart of HyperReducedRestShapeSpringsForceField — see header.
******************************************************************************/
#pragma once

#include <ModelOrderReduction/component/forcefield/HyperReducedRestShapeSpringsForceFieldKPCA.h>
...
HyperReducedRestShapeSpringsForceFieldKPCA<DataTypes>::HyperReducedRestShapeSpringsForceFieldKPCA()
{
}

template<class DataTypes>
void HyperReducedRestShapeSpringsForceFieldKPCA<DataTypes>::parse(core::objectmodel::BaseObjectDescription *arg)
{
    const char* attr = arg->getAttribute("external_rest_shape");
    if( attr != nullptr && attr[0] != '@')
    {
        msg_error() << "HyperReducedRestShapeSpringsForceFieldKPCA: 'external_rest_shape' must be a Link prefixed with '@'.";
    }
...
template<class DataTypes>
void HyperReducedRestShapeSpringsForceFieldKPCA<DataTypes>::bwdInit()
{
...
template<class DataTypes>
void HyperReducedRestShapeSpringsForceFieldKPCA<DataTypes>::reinit()
{
    if (d_stiffness.getValue().empty())
    {
        msg_info() << "No stiffness is defined, assuming equal stiffness on each node, k = 100.0 ";
...
template<class DataTypes>
void HyperReducedRestShapeSpringsForceFieldKPCA<DataTypes>::recomputeIndices()
{
    m_indices.clear();
    m_ext_indices.clear();
...
template<class DataTypes>
bool HyperReducedRestShapeSpringsForceFieldKPCA<DataTypes>::checkOutOfBoundsIndices()
{
...
template<class DataTypes>
const typename HyperReducedRestShapeSpringsForceFieldKPCA<DataTypes>::DataVecCoord*
HyperReducedRestShapeSpringsForceFieldKPCA<DataTypes>::getExtPosition() const
{
...
template<class DataTypes>
void HyperReducedRestShapeSpringsForceFieldKPCA<DataTypes>::addForce(const MechanicalParams* mparams, DataVecDeriv& f, const DataVecCoord& x, const DataVecDeriv& v)
{
    SOFA_UNUSED(mparams);
    SOFA_UNUSED(v);
...
template<class DataTypes>
void HyperReducedRestShapeSpringsForceFieldKPCA<DataTypes>::addDForce(const MechanicalParams* mparams, DataVecDeriv& df, const DataVecDeriv& dx)
{
...
template<class DataTypes>
void HyperReducedRestShapeSpringsForceFieldKPCA<DataTypes>::draw(const VisualParams *vparams)
{
...
template <class DataTypes>
void HyperReducedRestShapeSpringsForceFieldKPCA<DataTypes>::buildStiffnessMatrix(core::behavior::StiffnessMatrix* matrix)
{
    const VecReal& k = d_stiffness.getValue();
