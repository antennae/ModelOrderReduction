...
*   kPCA counterpart of HyperReducedTriangleFEMForceField — the triangle
*   sibling of HyperReducedTetrahedronFEMForceFieldKPCA. Used for the
...
class HyperReducedTriangleFEMForceFieldKPCA
    : public virtual TriangleFEMForceField<DataTypes>
    , public modelorderreduction::HyperReducedHelperKPCA
{
public:
    SOFA_CLASS2(SOFA_TEMPLATE(HyperReducedTriangleFEMForceFieldKPCA, DataTypes),
...
#if !defined(SOFA_COMPONENT_FORCEFIELD_HYPERREDUCEDTRIANGLEFEMFORCEFIELDKPCA_CPP)
extern template class SOFA_MODELORDERREDUCTION_API HyperReducedTriangleFEMForceFieldKPCA<sofa::defaulttype::Vec3Types>;
#endif
